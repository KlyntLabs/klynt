...
pub struct Ctx {
    pub request_id: Uuid,
    pub user_id: Option<klynt_common::util::UserId>,
}
...
impl Ctx {
    ...
    pub fn authenticated(request_id: Uuid, user_id: klynt_common::util::UserId) -> Self {
        Self {
            request_id,
...
mod tests {
    ...
    fn authenticated_context_carries_user() {
        let request_id = Uuid::new_v4();
        let user_id = klynt_common::util::UserId::new();
