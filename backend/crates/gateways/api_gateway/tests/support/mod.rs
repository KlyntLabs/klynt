...
pub struct LegacyFakeSessionStore {
    sessions: Mutex<HashMap<klynt_domain::session::SessionToken, klynt_domain::session::Session>>,
}

#[async_trait]
impl klynt_domain::session::SessionStore for LegacyFakeSessionStore {
    async fn create(
        &self,
...
pub fn test_config() -> api_gateway::Config {
    api_gateway::Config::default()
}
