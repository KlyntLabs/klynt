...
//! provides reusable implementations of [`Clock`], [`PasswordHasher`], and
//! helper functions for context and domain model construction so that service
//! tests don't duplicate the same fakes.
//!
